<template>
  <div id="main">
    ...
    <input type="text" name="gh-username" placeholder="Buscar usuário GitHub" v-model="username" v-on:keydown.13="search" :class="{ 'has-error': error }">

    <span class="loading" v-if="loading">Buscar usuário do GitHub"{{ username }}"...</span>
    ...
    <div class="box" v-if="results && !loading || error && !loading">
        ...
        <span v-if="error">Desculpa, não existe!"<i>{{ username }}</i>"!</span>
